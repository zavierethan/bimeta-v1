...
<div class="invoice p-3 mb-3" style="border:solid;border-color:white;height:1300px;">
              ...
              <div class="row invoice-info header">
                <div class="col-sm-5 invoice-col" style="padding-top: 70px;margin-left: 0px;padding-left: 38px;">
                ...
                <!-- /.col -->
                <div class="col-sm-2 invoice-col text-left" style="font-size: 21px;margin-top: 74px;border-top-width: 15px;padding-top:0px;">
                <!-- <p>Kepada Yth:</p> -->
              ...
              <div class="row">
                ...
                <div class="col-sm-4 text-center" style="margin-top: 7px;">
                    <div class="surat_jalan" style="padding-top: 15px;">
                  ...
                  <table class="table text-left" id="tabel_detail">
                    ...
                    <tbody>
                        ...
                        <tr style="font-size: 21px;" class="text-right">
                          <td class="text font-weight-bold" style="padding-left: 0px; width: 35px;">{{$no++}}</td>
                          <td width="" class="text font-weight-bold" style="width: 341px;padding-left: 7px;">{{$det_sj->nama_barang}}<br>{{$det_sj->ukuran}}<br>{{$det_sj->keterangan}}</td>
                          <td class="harga text font-weight-bold" style="padding-right: 32px;"><br>{{$det_sj->qty}}</td>
                          <td class="harga text font-weight-bold"></td>
                          <td class="text font-weight-bold"></td>
                          <td class="text font-weight-bold" style="padding-right: 0px;padding-left: 14rem;"><br>{{$det_sj->spesifikasi_barang}}</td>
                        </tr>
                        @endforeach
                    </tbody>

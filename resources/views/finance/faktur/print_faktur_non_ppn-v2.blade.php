    ...
    <div class="invoice p-3 mb-3">
        <div class="row">
          ...
          <div class="row">
              ...
              <div class="col" style="font-size: 25px;font-weight:bold;"><p>Nomor seri : {{$no_urut_faktur}}<br>Nomor PO : {{$header_faktur->no_po_customer}}<br>Tanggal &emsp;&ensp;: {{date('d/m/Y', strtotime($tgl_faktur))}} </p><br></div>
	  </div>
          <div class="row-24 header">
            <div class="col"><p><b>PEMBELI / PENERIMA : <br>Nama : {{$header_faktur->nama_customer}}<br>Alamat : {{$header_faktur->alamat_customer}}</b><br>No Surat Jalan : {{$string}}</br></p></div>
          </div>

...
<div class="container">
            <div class="card mt-5">
                <div class="card-header text-center">
                    <strong>Pelunasan Piutang Suplier</strong> 
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('finance.storejurnal') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="deskripsi_jurnal" id="deskripsi_jurnal" style="min-width: 200px;max-width: 600px;" required>
